...
{
    internal class MageFoodCondition : AbstractCondition
    {
        private IntegerInput valueInput;

        public MageFoodCondition()
        {
        ...
        {
            get { return "Mage Food"; }
        }

        public override string XmlName
        {
            get { return "MageFoodCondition"; }
        }
        ...
        public override bool IsOk
        {
            get
            {
                if (Condition.Equals(ConditionEnum.EqualTo))
                    return ObjectManager.MyPlayer.MageRefreshment == Value;
