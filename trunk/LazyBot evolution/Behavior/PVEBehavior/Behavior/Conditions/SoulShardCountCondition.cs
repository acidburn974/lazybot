...
namespace Behavior.PVEBehavior.Behavior.Conditions
{
    internal class SoulShardCountCondition : AbstractCondition
    {
        private IntegerInput valueInput;

        public SoulShardCountCondition()
        {
        ...
        {
            get { return "Soul Shard Count"; }
        }

        public override string XmlName
        {
            get { return "SoulShardCountCondition"; }
        }
        ...
        public override bool IsOk
        {
            get
            {
                if (Condition.Equals(ConditionEnum.EqualTo))
                    return ObjectManager.MyPlayer.SoulShard == Value;
        ...
        private void CreateCondition(List<Node> re)
        {
            ...
            condition.Text = "Soul Shard count is ";
