...
using Behavior.PVEBehavior.Behavior;
using DevComponents.DotNetBar;
using Type = Behavior.PVEBehavior.Behavior.Type;

namespace Behavior.PVEBehavior.Builders.Deathknight
{
    internal partial class DeathknightBuilder : Office2007Form
    {
        private List<AddToBehavior> _items;

        public DeathknightBuilder()
        {
            InitializeComponent();
        }

        private void DeathknightBuilderLoad(object sender, EventArgs e)
        {
            TBName.Text = "Deathknight";
            _items = Deathknight.Load();
