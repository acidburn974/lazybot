...
using Behavior.PVEBehavior;
using Behavior.PVEBehavior.Behavior;
using Behavior.PVEBehavior.Behavior.Conditions;
using LazyLib;
using LazyLib.ActionBar;
using LazyLib.Helpers;
using LazyLib.Wow;

namespace Behavior.RotationPlugin
{
    public partial class RotatorForm : Office2007Form
    {
