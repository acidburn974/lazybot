...
namespace LazyLib.Helpers
{
    ...
    public class Inventory
    {
        ...
        {
            get { return ObjectManager.GetContainers.FirstOrDefault(container => BagHelper.Bag1GUID == container.GUID); }
        }

        public static PContainer Bag2
        {
            get { return ObjectManager.GetContainers.FirstOrDefault(container => BagHelper.Bag2GUID == container.GUID); }
        }

        public static PContainer Bag3
        {
            get { return ObjectManager.GetContainers.FirstOrDefault(container => BagHelper.Bag3GUID == container.GUID); }
        }

        public static PContainer Bag4
        {
            get { return ObjectManager.GetContainers.FirstOrDefault(container => BagHelper.Bag4GUID == container.GUID); }
        }
