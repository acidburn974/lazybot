...
namespace LazyLib.LazyRadar
{
    public partial class RadarForm : Office2007Form
    {
        ...
        private readonly IniManager _pIniManager;
        ...
        public RadarForm()
        {
            ...
            _pIniManager = new IniManager(_ourDirectory + SettingsName);
        }
        ...
        public void AddDrawItem(IDrawItem item)
        {
            ...
            if (_pIniManager.GetBoolean("Radar", item.SettingName(), false))
            {
                cb.Checked = true;
        ...
        private void DrawItemClick(object sender, EventArgs e)
        {
            ...
            lock (_locker)
            {
                ...
                _pIniManager.IniWriteValue("Radar", (string) cb.Tag, cb.Checked.ToString());
            }
        }
