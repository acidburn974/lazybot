...
namespace LazyLib.Wow
{
    ...
    public class PUnit : PObject
    {
        ...
        public Single Speed
        {
            get
            {
                return PUnitHelper.Speed(BaseAddress);
            }
        }
        ...
        {
            get { return PUnitHelper.CreatureType(BaseAddress); }
        }
        ...
        */
        ...
        {
            get { return PUnitHelper.IsAutoAttacking(BaseAddress); }
        }
        ...
        public bool IsSwimming
        {
            get
            {
                return PUnitHelper.IsSwimming(BaseAddress);
            }
        }
        ...
        public bool IsFlying
        {
            get
            {
                return PUnitHelper.IsFlying(BaseAddress);
            }
        }
        ...
        public bool HasBuff(int buff, bool playerShouldBeOwner)
        {
            ...
            try
            {
                var auras = PUnitHelper.GetAuras(BaseAddress);
        ...
        {
            get { return PUnitHelper.GetAuras(BaseAddress); }
        }
        ...
        public uint BuffTimeLeft(int spellId)
        {
            try
            {
                return (from woWAura in PUnitHelper.GetAuras(BaseAddress) where woWAura.SpellId == spellId select woWAura.SecondsLeft).FirstOrDefault();
            }
            catch
            {
                return 0;
        ...
        {
            return PUnitHelper.GetAuras(BaseAddress).Select(woWAura => woWAura.SpellId).ToList();
        }
        ...
        public int BuffStacks(int spellId)
        {
            try
            {
                return (from woWAura in PUnitHelper.GetAuras(BaseAddress) where woWAura.SpellId == spellId select woWAura.Stack).FirstOrDefault();
            }
            catch (Exception)
            {
                return 0;
